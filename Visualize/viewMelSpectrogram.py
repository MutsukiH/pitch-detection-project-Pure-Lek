...
for i in range(48,60): # ช่วง octave 4
    ...
    mel_spectrogram = librosa.feature.melspectrogram(y = signal, sr=22050, n_fft=2048, hop_length=512, n_mels=128) # n_mel คือจำนวน mel band ที่จะแบ่ง 
    # ปรับให้สเกลเป็น log
    ...
    plt.savefig('.\Visualize\melspec\melSpec'+'spectrogram_' + NOTES[i-48]+'.png')
