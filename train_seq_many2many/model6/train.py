...
train(train_data_loader, encoder, decoder, 100, print_every=5, plot_every=5)

torch.save(encoder.state_dict(), f"train_seq_many2many\model6\enmodel.pth")
torch.save(decoder.state_dict(), f"train_seq_many2many\model6 \demodel.pth")
