...
writer = SummaryWriter('runs/model9_3')
...
ANNOTATIONS_FILE_train = r"data_real\norest_1\train_start0.csv"
ANNOTATIONS_FILE_test = r"data_real\norest_1\test_start0.csv"
AUDIO_DIR = r"data_real\norest_1"
SAMPLE_RATE = 16000
NUM_SAMPLES = 22050
time_length = 100
max_length = 60
...
torch.save(encoder.state_dict(), f"train_seq_many2many\model9\enmodel.pth")
torch.save(decoder.state_dict(), f"train_seq_many2many\model9\demodel.pth")
